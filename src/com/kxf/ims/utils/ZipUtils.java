...
public class ZipUtils {
	private static final String charsetName_zip = "ISO-8859-1";//ISO-8859-1
	private static final String charsetName = "utf-8";//GBK
    ...
    public static byte[] compress(String str) throws IOException {
        ...
        gzip.close();
        // 使用指定的 charsetName，通过解码字节将缓冲区内容转换为bytes
    ...
    public static String compressStr(String str) throws IOException {
        return new String(compress(str), charsetName_zip);
    }
    ...
    public static String unCompressStr(String str) throws IOException {
        return new String(unCompress(str), charsetName);
    }
}